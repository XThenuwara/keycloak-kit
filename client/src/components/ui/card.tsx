...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-sm border bg-card dark:bg-gray-900 text-card-foreground shadow", className)} {...props} />);
